...
function winGame(){
    ...
    inputText.setAttribute('style', 'background-color: rgba(102, 155, 188, .3); color: #f5e2c8;');
    
    var submitBtn = document.createElement('button');
    submitBtn.setAttribute('class', 'submit-button');
    submitBtn.innerHTML =('Submit');
    submitBtn.setAttribute('style', 'display: block; margin: 3rem auto; max-width: 20rem; font-size: 2rem; font-weight: bold; text-decoration: none; border: 1px solid #d88373; border-radius: 4px; padding: 5px 10px; background-color: #d88373; color: #212121;');
